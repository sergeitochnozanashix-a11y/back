...
import software.pxel.learneasy.api.dto.content.properties.HeadingProperties;
import software.pxel.learneasy.model.enums.ContentBlockType;

import java.util.List;

public record HeadingBlockDTO(
        @Positive Long id,
        @JsonProperty("blockType") @NotNull ContentBlockType blockType,
        @NotBlank(message = "Заголовок не может быть пустым") String content,
        @Valid HeadingProperties properties
