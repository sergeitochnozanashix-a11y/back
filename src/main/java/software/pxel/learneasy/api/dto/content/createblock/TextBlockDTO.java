...
import software.pxel.learneasy.api.dto.content.properties.TextProperties;
...
public record TextBlockDTO(
        ...
        @NotBlank(message = "Текстовое содержимое не может быть пустым") String content,
        @Valid TextProperties properties
